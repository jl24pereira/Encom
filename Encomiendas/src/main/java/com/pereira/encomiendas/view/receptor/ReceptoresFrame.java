...
public class ReceptoresFrame extends javax.swing.JInternalFrame {

    private static final ReceptoresFrame FRAME = new ReceptoresFrame();
    private final ReceptorController receptorController;
    private final ReceptoresTableModel tmReceptores;
    TableRowSorter<TableModel> sorter;

    public ReceptoresFrame() {
    ...
    private void btnAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarActionPerformed
        ...
        Create dialog = new Create(new JFrame(), true, "NUEVO RECEPTOR");
    ...
    public static ReceptoresFrame getFrame() {
        return FRAME;
    }

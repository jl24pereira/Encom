...
public class Create extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        txtDui.setMinimumSize(new java.awt.Dimension(200, 30));
        txtDui.setPreferredSize(new java.awt.Dimension(200, 30));
    ...
    private void txtDuiKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtDuiKeyReleased
        controller.getSeleccionado().setDui(txtDui.getText());
    ...
    private void txtMunicipioKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtMunicipioKeyReleased
        controller.getSeleccionado().setMunicipio(txtMunicipio.getText());
    ...
    private void txtDeptoKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtDeptoKeyReleased
        controller.getSeleccionado().setDepartamento(txtDepto.getText());
    ...
    private void cargarForm() {
        ...
        this.txtDepto.setText(controller.getSeleccionado().getDepartamento());
    }
}
